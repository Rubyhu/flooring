...
<form action="upProAction.action" method="post" enctype="multipart/form-data">
    <div class="centers_m">
  <div class="upload-left">
    <div class="req-push-title"><p class="req-name"><span>新产品上线啦</span></p></div>
    ...
    <div class="form-box-list">
      ...
      <div class="tab-r "><input type="text"  class="form-area-txt tit" name="pro_title" placeholder="产品名称"/></div>
   ...
   <div class="form-box-list">
      ...
      <div class="tab-r">
      	<input type="radio" name="tit_id" value="1" />卧室
      	<input type="radio" name="tit_id" value="2"/>客厅
      	<input type="radio" name="tit_id" value="3" />餐厅
      	<input type="radio" name="tit_id" value="4"/>书房
      	<input type="radio" name="tit_id" value="5" />儿童房
      	<input type="radio" name="tit_id" value="6"/>家纺
      	<input type="radio" name="tit_id" value="7" />软装饰
      </div>
     
      <div class="clearfiexd"></div>
    </div>
     <div class="form-box-list">
      <div class="tab-l"><span class="form-box-label">产品展示</span></div>
