<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
     <%@ page import="java.util.List,com.po.Service" %>
<!DOCTYPE html>
...
<div class="service">
	<div class="container clearfix">
    	...
    	<div class="service_title">
    		<h3 class="box2_nm">服务中心<span>OFFERED SERVICE</span></h3>
    		<div class="box2_line"></div>
   		</div>
        <div class="service_txt">
        木地板在铺设竣工,不同季节的考验，发生少量变化，乃属正常。在质量保证期内地板按《木地板保修期内面层检验规范》执行。具体是谁铺设，谁承担保修责任,保护客户利益，绝不推诿。
        </div>
        <div class="service_main">
    		<div class="ser_main_left">
            	<div class="left_box">
                	<div class="left_main">
                    <h3>服务承诺</h3>
                    <ul class="clearfix">
            <% List<Service> AllService=(List)session.getAttribute("AllService"); 
			   if(AllService==null)
			   {
				   response.sendRedirect("ShowAllServiceAction.action");
				   return;
			   }
			   for(int i=AllService.size()-1;i>=0;i--)
			   {
				   if(AllService.get(i).getPromis()==null){
					   continue;
				   }
				   %>
                    	<li><%=AllService.get(i).getPromis()%></li>
            <%} %>
                    </ul>
                    </div>
                </div>    
            </div>
            <div class="ser_main_center">
            	<ul>
                <li><div class="center_pic"><img src="images/service1.jpg" style="width:80%;"></div><p></p></li>
                <li><div class="center_pic"><img src="images/service2.jpg" style="width:80%;"></div><p></p></li>
                <li><div class="center_pic"><img src="images/service3.jpg" style="width:80%;"></div><p></p></li>
                </ul>
            </div>
        	<div class="ser_main_right">
            	<div class="right_main">
                <h3>保养知识</h3>
                <ul class="clearfix">
                 <% List<Service> AllServiceKno=(List)session.getAttribute("AllService"); 
			   if(AllServiceKno==null)
			   {
				   response.sendRedirect("ShowAllServiceAction.action");
				   return;
			   }
			   for(int i=AllServiceKno.size()-1;i>=0;i--)
			   {
				   if(AllServiceKno.get(i).getTitle()==null){
					   continue;
				   }
				   %>
                <li>
                	<div class="right_tit"><%=AllServiceKno.get(i).getTitle()%></div>
                	<div class="right_txt"><%=AllServiceKno.get(i).getKnowage()%></div>
                </li>
             <%} %>
                </ul>
                </div>
